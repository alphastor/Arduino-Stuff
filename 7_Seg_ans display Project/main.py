...
funcs_1 = {'0': zero, '1': one, '2': two, '3': three, '4': four, '5': five, '6': six, '7': seven, '8': eight, '9': nine, '-': minus}  
...
def clear():
     ...
     usr_input.delete(length-20, 'end') #length-20 is number of characters to remove from inout box

#---------------------------------------------------------------------------------------------------------------#

btn_calculate =  Button(win, text = "Calculate", width = 10, command=calculate, font= "AnaEve") 
btn_cleardisplay = Button(win, text = "Clear Display", width = 10, command=clear_display, font= "AnaEve")
...
usr_input = Entry(win, textvariable = usr_val, font = 'Cooper 15') # initialising user input area
